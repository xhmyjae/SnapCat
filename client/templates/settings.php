        ...
        <form action="/settings" enctype="multipart/form-data" id="settings-form" method="POST">
            ...
            <div class="avatar-settings settings-category">
                ...
                <div class="avatar-box">
                    ...
                    <input class="form-control form-control-avatar" id="catspaghetti" name="avatar" value="catspaghetti"
                           type="radio" <?php if ($connected_user->avatar === 'catspaghetti') echo "checked" ?>>
                </div>
                <div class="avatar-box">
                    <img class="avatar-choices" src="client/templates/img/catdepressed.png" alt="avatar">
                    <input class="form-control form-control-avatar" id="catdepressed" name="avatar" value="catdepressed"
                           type="radio" <?php if ($connected_user->avatar === 'catdepressed') echo "checked" ?>>
                </div>
                <div class="avatar-box">
                    <img class="avatar-choices" src="client/templates/img/cathaha.png" alt="avatar">
                    <input class="form-control form-control-avatar" id="cathaha" name="avatar" value="cathaha"
                           type="radio" <?php if ($connected_user->avatar === 'cathaha') echo "checked" ?>>
                </div>
                <div class="avatar-box">
                    <img class="avatar-choices" src="client/templates/img/cathefuck.png" alt="avatar">
                    <input class="form-control form-control-avatar" id="cathefuck" name="avatar" value="cathefuck"
                           type="radio" <?php if ($connected_user->avatar === 'cathefuck') echo "checked" ?>>
                </div>
                <div class="avatar-box">
                    <img class="avatar-choices" src="client/templates/img/catstare.png" alt="avatar">
                    <input class="form-control form-control-avatar" id="catstare" name="avatar" value="catstare"
                           type="radio" <?php if ($connected_user->avatar === 'catstare') echo "checked" ?>>
                </div>
            </div>
            ...
            <div class="confirm-password-settings settings-category">
                ...
                <button class="custom-btn settings-button btn-8" type="submit" name="submit-settings" value="settings">
                    VALIDER
                </button>
            </div>
