                ...
                <div class="modal-information">
                    ...
                    <div class="modal-reactions">
                        <div class="modal-reaction">
                            <a href="" class="modal-reaction-icon"><i class="fa-solid fa-thumbs-up reaction-icon"></i><p class="modal-reaction-number">222</p></a>
                        </div>
                        <div class="modal-reaction">
                            <a href="" class="modal-reaction-icon"><i class="fa-solid fa-thumbs-down reaction-icon"></i><p class="modal-reaction-number">222</p></a>
                        </div>
                        <div class="modal-reaction">
                            <a href="" class="modal-reaction-icon"><i class="fa-solid fa-heart reaction-icon"></i><p class="modal-reaction-number">222</p></a>
                        </div>
                        <div class="modal-reaction">
                            <a href="" class="modal-reaction-icon"><i class="fa-solid fa-star reaction-icon"></i><p class="modal-reaction-number">222</p></a>
                        </div>
                        <div class="modal-reaction">
                            <a href="" class="modal-reaction-icon"><i class="fa-solid fa-star reaction-icon"></i><p class="modal-reaction-number">222</p></a>
                        </div>
                    ...
                    <div class="modal-comments">
                        <?php foreach ($post_comments as $comment) {
                            ...
                            <div class="modal-comment">
                                <img class="modal-comment-avatar" src="../img/<?= $comment_user->avatar ?>.png" alt="comment avatar">
