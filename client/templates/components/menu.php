...
<div class="menu">
    <div class="site-title-box">
        ...
        <img src="client/templates/img/logo.png" alt="logo" id="logo">
    </div>
    <div class="categories">
        <ul>
            <li class="category"><a href="/homepage"><span class="list-icon"><i
                                class="fa-regular fa-comment"></i></span>Accueil</a></li>
